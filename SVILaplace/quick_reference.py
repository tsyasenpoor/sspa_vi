...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help='Laplace prior scale for v (larger=less regularization, smaller=more shrinkage)'
    )
    parser.add_argument(
        '--sigma-gamma',
        type=float,
...
def main():
    ...
    # =========================================================================
    from SVILaplace.svi import SVI
    from SVILaplace.data_loader import DataLoader
    from SVILaplace.utils import (
    ...
    print(f"  b_laplace:    {args.b_laplace:.4f}")
